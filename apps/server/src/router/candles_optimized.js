...
export const optimizedCandlesRouter = Router();
// Input validation schema
const validateCandlesRequest = (req, res, next) => {
    ...
    if (!validTimeframes.includes(ts)) {
        return res.status(400).json({
...
optimizedCandlesRouter.get("/", performanceMiddleware.cache(60), // Cache for 1 minute
validateCandlesRequest, async (req, res) => {
...
optimizedCandlesRouter.get("/bulk", performanceMiddleware.cache(120), // Cache for 2 minutes
async (req, res) => {
    try {
...
//# sourceMappingURL=candles_optimized.js.map